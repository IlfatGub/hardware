 ...
 * @property int verification       Верификация
 *
 *
 * @property int _model
...
class HwTehnic extends ModelInterface
{
	...
	public function rules()
	{
		return [
			...
			[['count', 'id_parent_tehnic', 'verification'], 'integer'],
	 ...
	 * Верфикация
	 */
	public static function getVerifictaion() : array
	{
		return [
			1 => 'Не проверен',
			2 => 'Проверен/Есть расхождения',
			3 => 'Верифицирован',
		];
	}
