                ...
                <?php if (!$type): ?>
                    <tr class="fs-16">
                        <th colspan="9">
                            ...
                            <a href="<?= \yii\helpers\Url::toRoute(['users', 'update' => $id_user]) ?>"
                               class="fas fa-edit"></a>
                        </th>
                    </tr>
                <?php endif; ?>
            ...
            <?php foreach ($model as $key => $item): ?>
                <tr id="hw-tehnic-<?= $item->id ?>" class="<?= $item->id == $_update ? 'alert-warning' : '' ?>">
                    ...
                    <td style="max-width: 250px" class="field-id_model <?= $none ?>">
                        <span style="display: none"> <?= $_model[$item->id_model] // Для корректной сортировки         ?>  </span>
                    ...
                    <td class="field-serial <?= $none ?>">
                        <?php if (Yii::$app->user->can('Admin')): ?>
                            <input class="form-control form-control-navbar form-control-sm border_no height-25 tehnic-input"
                                   data-key="serial" data-parent="/site/tehnic-ajax"
                                   id="<?= $item->id ?>" value="<?= $item->serial ?>">
                        <?php else: ?>
                            <?= $item->serial ?>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="field-fio <?= $none ?>">
                        <span style="display: none"> <?= isset($item->id_user) ? $_user[$item->id_user] : '' // Для корректной сортировки          ?>  </span>
                    ...
                    <td class="field-location <?= $none ?>">
                        <?php if (Yii::$app->user->can('Admin')): ?>
                            <input class="form-control form-control-navbar form-control-sm border_no height-25 tehnic-input"
                                   data-key="location" data-parent="/site/tehnic-ajax"
                                   id="<?= $item->id ?>" value="<?= $item->location ?>">
                        <?php else: ?>
                            <?= $item->location ?>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="field-nomen <?= $none ?>">
                        <?php if (Yii::$app->user->can('Admin')): ?>
                            <input class="form-control form-control-navbar form-control-sm border_no height-25 tehnic-input"
                                   data-key="nomen" data-parent="/site/tehnic-ajax"
                                   id="<?= $item->id ?>" value="<?= $item->nomen ?>">
                        <?php else: ?>
                            <?= $item->nomen ?>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="field-balance <?= $none ?>">
                        <div class="icheck-primary d-inline ml-2">
                            <input type="checkbox" class="check-balance height-25" value="" name="todo1"
                                   id="<?= $item->id ?>" <?= $item->balance ? "checked" : '' ?>>
                    ...
                    <td class="field-act_num <?= $none ?>">
                        <?php if (Yii::$app->user->can('Admin')): ?>
                            <input class="form-control form-control-navbar form-control-sm border_no height-25 tehnic-input"
                                   data-key="act_num" data-parent="/site/tehnic-ajax"
                                   id="<?= $item->id ?>" value="<?= $item->act_num ?>">
                        <?php else: ?>
                            <?= $item->act_num ?>
                        <?php endif; ?>
                    </td>
                    ...
                    <td style="width: 100px" class=" field-button <?= $none ?>">
                        ...
                        <div class="tools">
                            <a href="<?= \yii\helpers\Url::toRoute(['tehnic', 'update' => $item->id, 'id_user' => $id_user]) ?>"
                               class="fas fa-edit"></a>
